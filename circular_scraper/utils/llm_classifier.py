...
class LLMClassifier:
    ...
    def _build_prompt(self, context: Dict[str, Any]) -> List[Dict[str, str]]:
        ...
        system = (
            ...
            "Circular Economy (CE) relevance includes recycling, resource efficiency, waste management, reuse, bioeconomy, etc. "
            "Role examples: HEI, Research Institute, Public Authority, Industry Partner, Startup, NGO, Funding Body, Policy Maker, Knowledge Hub, Innovation center, Citizen Association. "
            "If uncertain, set booleans conservatively to false and role to 'Unknown'. Output JSON only."
        )
        user = {
            "entity": {
