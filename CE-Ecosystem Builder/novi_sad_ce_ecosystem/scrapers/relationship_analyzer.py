...
from novi_sad_ce_ecosystem.config.relationship_prompts import (
...
from novi_sad_ce_ecosystem.utils.ollama_structured import (
...
class RelationshipAnalyzer:
    ...
    def cluster_ce_capabilities(
        ...
        for batch_idx, batch in enumerate(batches, 1):
            ...
            from novi_sad_ce_ecosystem.utils.ollama_structured import estimate_tokens
