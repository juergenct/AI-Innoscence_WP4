...
def fetch_website_content(
    ...
    # Common subpages to check (Serbian, English, German)
    subpages_to_check = [
        '',  # Homepage
        '/about', '/about-us', '/o-nama', '/onama',  # Serbian: o nama
        '/contact', '/kontakt', '/contact-us',
        '/impressum', '/imprint', '/legal',
        '/sustainability', '/odrzivost', '/održivost',  # Serbian: održivost
        '/circular-economy', '/kruzna-ekonomija', '/kružna-ekonomija',  # Serbian: kružna ekonomija
        '/services', '/usluge', '/delatnost',  # Serbian: services/activities
        '/recycling', '/reciklaza', '/reciklaža'  # Serbian: reciklaža
    ]
    ...
    # Combine all text and limit size (reduced from 15000 to 8000 to prevent JSON truncation)
    combined = '\n'.join(all_text)
