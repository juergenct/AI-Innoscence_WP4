...
def fetch_website_content(
    ...
    # Common subpages to check (Romanian, Russian & English)
    subpages_to_check = [
        '',  # Homepage
        '/about', '/about-us', '/despre-noi', '/despre', '/o-nas',
        '/contact', '/contacte', '/kontakty', '/contact-us',
        '/legal', '/informatii-juridice', '/juridiceskie-informacii', '/imprint',
        '/sustainability', '/sustenabilitate', '/ustojchivost', '/circular-economy', '/economie-circulara'
    ]
