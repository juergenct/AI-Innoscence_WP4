...
BASIC_INFO_PROMPT = r'''
Extract the core identification information for this Cahul-based entity.

CONTEXT: You are analyzing an organization's website to understand who they are,
what they do, and where they're located in the Cahul circular economy ecosystem.
...
1. ENTITY NAME:
   ...
   - If official name not clearly stated, derive from domain name
     Examples: "ecotech.md" → "EcoTech", "ecoinovare.com" → "EcoInovare"
...
2. ECOSYSTEM ROLE:
   ...
   - Public Authorities: Government bodies, Autorități publice, Государственные органы, municipal services, Municipiul Cahul
...
4. ADDRESS:
   ...
   - Legal information section (Informații juridice, Юридическая информация, Legal Info - HIGHEST PRIORITY!)
   - Contact page ("Contacte", "Контакты", "Contact Us")
   - Footer (bottom of every page)
   - About page ("Despre noi", "О нас", "About Us")
   - Location page

   Extract in format: "Street Number, Postal Code City"
   Examples:
   - "Str. Republicii 15, MD-3000 Cahul"
   - "Bulevardul Independenței 22, MD-3901 Cahul"
   - "Strada Ștefan cel Mare 8, MD-3000 Cahul"

   IMPORTANT: Moldovan companies typically have legal information pages (Informații juridice, Юридическая информация).
   Look for postal code pattern: MD-xxxx (Cahul: MD-3000, MD-3901, MD-3905, MD-3907, MD-3909)
...
Extract ALL contact information for this Cahul organization.
...
1. EMAILS:
   ...
   - Contact page ("Contacte", "Контакты", "Contact Us")
   - Footer (bottom of every page)
   - Legal information section (Informații juridice, Юридическая информация - check here first!)
   - Team/About pages ("Despre noi", "Echipă", "О нас", "Команда", "Team", "About Us")
   - Header contact bar

   ONLY extract explicitly shown emails - do NOT construct or infer.
   Examples of what to extract:
   - "info@ecotech.md" → extract it
   - "contact@ecoinovare.com" → extract it
   - "For inquiries: office@greentech.md" → extract "office@greentech.md"
...
2. PHONE NUMBERS:
   ...
   Common Moldova formats:
   - +373 XXX XXXXX (Moldova landline/mobile with country code)
   - (0XXX) XX-XX-XX (local format)
   - 0XXX XXXXXX (alternative format)
...
3. CONTACT PERSONS:
   ...
   Where to look:
   - Team page ("Echipă", "Команда", "Team", "Despre noi", "О нас", "About Us")
   - About/Leadership section (Conducere, Руководство)
   - Legal information section (Director, Administrator, Conducere, Директор)
   - Contact page ("Contacte", "Контакты", "Contact")
...
CONTEXT: We are mapping the Cahul CE ecosystem to identify who can provide what
...
2. CE ACTIVITIES STRUCTURED:
   ...
   **INFERENCE RULES:**
   ...
   - Text: "operates 12 recycling centers in Cahul"
     → {"activity_name": "Recycling Center Operations", "description": "Operating 12 recycling centers across Cahul", "category": "Waste Management"}
...
CONTEXT: Understanding the network of partnerships helps us map the Cahul CE
...
1. MENTIONED PARTNERS:
   ...
   **WHAT TO EXTRACT:**
   ...
   - Text: "In partnership with Cahul Wasser for sustainable water management"
     → {"name": "Cahul Wasser", "url": null, "context": "Partnership for sustainable water management"}
   ...
   - Text: "Project partners: TUHH, Fraunhofer ISI, Stadt Cahul"
     → [
       {"name": "TUHH", "url": null, "context": "Project partner"},
       {"name": "Fraunhofer ISI", "url": null, "context": "Project partner"},
       {"name": "Stadt Cahul", "url": null, "context": "Project partner"}
     ]

   Include:
   - Formal partners ("Partner", "Parteneri", "Партнёры")
   - Clients (if named in case studies/references)
   - Network members (if entity is a network/cluster)
   - Collaboration partners in projects (colaborare, сотрудничество)

2. DISCOVERED ENTITIES:
   Extract OTHER organizations mentioned that could be relevant to Cahul CE ecosystem.
   ...
   **CORRECT OUTPUT EXAMPLES:**
   ...
   Text: "Read more about EcoTech Moldova's innovative recycling at www.ecotech.md"
   ✓ CORRECT:
   {
     "name": "EcoTech Moldova",
     "url": "https://www.ecotech.md",
     "brief_description": "Innovative recycling company",
     "context": "Mentioned in blog post about recycling innovations"
   }

   Text: "Moldova Innovation Hub (innovationhub.md) supports CE startups"
   ✓ CORRECT:
   {
     "name": "Moldova Innovation Hub",
     "url": "https://innovationhub.md",
   ...
   **WHERE TO FIND DISCOVERED ENTITIES:**
   ...
   - "Related organizations" or "Network/Rețea/Сеть" sections with websites
...
3. PARTNERS (Legacy):
   ...
   Examples: ["Cahul Wasser", "TUHH", "Fraunhofer ISI"]
